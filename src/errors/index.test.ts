...
test("errors", async (t) => {
  ...
  await t.test("TimeoutAppleEventError", async (t) => {
    await t.test("creates timeout apple event error", () => {
      const error = new TimeoutAppleEventError(
        "Timeout occurred",
        "com.apple.Safari",
        "testOp",
      );
  ...
  await t.test("TimeoutOSAScriptError", async (t) => {
    await t.test("creates timeout osascript error", () => {
      const error = new TimeoutOSAScriptError(
        "OSA timeout",
        "com.apple.Safari",
        "testOp",
        30000,
  ...
  await t.test("OutputValidationError", async (t) => {
    await t.test("creates output validation error", () => {
      const issues = [{ path: ["result"], message: "Invalid format" }];
  ...
  await t.test("createErrorFromCode", async (t) => {
    ...
    await t.test(
      "creates InvalidReturnTypeError for invalid return type codes",
      () => {
        const rowsError = createErrorFromCode(
        ...
        const sectionsError = createErrorFromCode(
        ...
        const scalarError = createErrorFromCode(
    ...
    await t.test(
      "creates InvalidActionCodeError for invalid action code",
      () => {
        const error = createErrorFromCode(
  ...
  await t.test("type guards", async (t) => {
    ...
    await t.test("isTimeoutError", () => {
      const timeoutAppleEvent = new TimeoutAppleEventError(
        "Timeout",
        "app",
        "op",
      );
      const timeoutOSAScript = new TimeoutOSAScriptError(
        "Timeout",
        "app",
        "op",
        5000,
  ...
  await t.test("getUserFriendlyMessage", async (t) => {
    ...
    await t.test("returns message for timeout errors", () => {
      const timeoutError = new TimeoutAppleEventError(
        "Timeout occurred",
        "com.apple.Safari",
        "testOp",
      );
  ...
  await t.test("error inheritance and properties", async (t) => {
    ...
    await t.test("error properties are preserved", () => {
      const timeoutError = new TimeoutOSAScriptError(
        "Timeout",
        "app",
        "op",
        5000,
    ...
    await t.test("error kinds are correctly assigned", () => {
      const errors = [
        {
          error: new TimeoutAppleEventError("", "app", "op"),
          expectedKind: "TimeoutAppleEventError",
        },
        {
          error: new MissingReturnError("", "op"),
          expectedKind: "MissingReturnError",
        },
        {
          error: new InvalidReturnTypeError("", "type", "op"),
          expectedKind: "InvalidReturnTypeError",
        },
        {
          error: new InvalidActionCodeError("", "op"),
          expectedKind: "InvalidActionCodeError",
        },
        { error: new ScriptError("", -1, "op"), expectedKind: "ScriptError" },
        { error: new ParseError("", "raw", "op"), expectedKind: "ParseError" },
        {
          error: new InputValidationError("", [], "op"),
          expectedKind: "InputValidationError",
        },
        {
          error: new OutputValidationError("", [], "op"),
          expectedKind: "OutputValidationError",
        },
      ];
  ...
  await t.test("edge cases", async (t) => {
    ...
    await t.test("handles complex validation issues", () => {
      ...
      const outputError = new OutputValidationError(
        "Complex output validation failed",
        complexIssues,
        "processUser",
      );
